...
$document = new Document(
    ...
    creatorTool: 'examples/table-of-contents.php',
);
...
$coverPage->addText(
    'A compact example showing outlines and an auto-generated table of contents.',
...
$coverPage->createTextFrame(
    ...
    'The content pages are created first, outline entries are registered for the visible chapters and the table of contents is inserted at the start afterwards. That keeps the example close to a realistic document-building workflow.',
    'Helvetica',
    12,
...
$chapters = [
    [
        ...
        'body' => [
            ...
            'At the end, addTableOfContents(...) inserts one or more TOC pages at the beginning of the document.',
        ],
    ],
    [
        'title' => 'Usage',
    ...
    [
        ...
        'body' => [
            'The example uses automatic page numbers so the generated TOC can reference the final page count after insertion at the front of the document.',
            'The TOC is inserted after the cover and chapter pages have been registered, so the final page numbers are resolved against the finished document structure.',
        ],
    ],
];
...
$outputPath = $outputDir . '/table-of-contents.pdf';
