...
$document = new Document(
    ...
    creatorTool: 'examples/table-of-contents-end.php',
);
...
$coverPage->createTextFrame(
    ...
    'The content pages are created first, outline entries are registered for the visible chapters and the table of contents is appended at the end afterwards. That keeps the comparison with the start-position example straightforward.',
    'Helvetica',
    12,
...
$chapters = [
    [
        ...
        'body' => [
            ...
            'At the end, addTableOfContents(...) appends one or more TOC pages after the content pages.',
        ],
    ],
    [
        'title' => 'Usage',
    ...
    [
        ...
        'body' => [
            'The example uses automatic page numbers so the generated TOC can reference the final page count after all content pages have been written.',
            'Because the TOC stays at the end in this variant, the chapter pages remain on their original physical page numbers.',
        ],
    ],
];
