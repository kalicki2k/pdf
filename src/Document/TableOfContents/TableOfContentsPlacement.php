...
final readonly class TableOfContentsPlacement
{
    ...
    {
        return $this->position === TableOfContentsPosition::START;
    }

    public function isEnd(): bool
    {
        return $this->position === TableOfContentsPosition::END;
    }

    public function isAfterPage(): bool
    {
        return $this->position === TableOfContentsPosition::AFTER_PAGE;
    }
