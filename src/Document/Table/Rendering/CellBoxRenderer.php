...
final readonly class CellBoxRenderer
{
    ...
    public function render(
        ...
        $topBorder = $this->styleResolver->resolveBorderSide('top', $defaultBorder, $rowBorder, $cellBorder);
        $rightBorder = $this->styleResolver->resolveBorderSide('right', $defaultBorder, $rowBorder, $cellBorder);
        $bottomBorder = $this->styleResolver->resolveBorderSide('bottom', $defaultBorder, $rowBorder, $cellBorder);
        $leftBorder = $this->styleResolver->resolveBorderSide('left', $defaultBorder, $rowBorder, $cellBorder);
