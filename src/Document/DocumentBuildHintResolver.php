...
final class DocumentBuildHintResolver
{
    ...
    private function hintForError(Document $document, DocumentBuildError $error): ?string
    {
        return match ($error) {
            ...
            DocumentBuildError::IMAGE_LAYOUT_INVALID => 'Adjust image dimensions, spacing or page margins so the image can fit within the available page content area, or enable automatic page breaks.',
