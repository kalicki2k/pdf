...
final class StandardFontMetrics
{
    ...
    private const array DESCENTS = [
        StandardFont::COURIER->value => 0.194,
        StandardFont::COURIER_BOLD->value => 0.194,
        StandardFont::COURIER_BOLD_OBLIQUE->value => 0.194,
        StandardFont::COURIER_OBLIQUE->value => 0.194,
        StandardFont::HELVETICA->value => 0.207,
        StandardFont::HELVETICA_BOLD->value => 0.207,
        StandardFont::HELVETICA_BOLD_OBLIQUE->value => 0.207,
        StandardFont::HELVETICA_OBLIQUE->value => 0.207,
        StandardFont::SYMBOL->value => 0.18,
        StandardFont::TIMES_BOLD->value => 0.218,
        StandardFont::TIMES_BOLD_ITALIC->value => 0.218,
        StandardFont::TIMES_ITALIC->value => 0.217,
        StandardFont::TIMES_ROMAN->value => 0.217,
        StandardFont::ZAPF_DINGBATS->value => 0.143,
    ];
    ...
    public static function descent(string $baseFont, float $size): float
    {
        return (self::DESCENTS[$baseFont] ?? 0.2) * $size;
    }
