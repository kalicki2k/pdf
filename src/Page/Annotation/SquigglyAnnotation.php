...
final class SquigglyAnnotation extends DictionaryIndirectObject implements AppearanceStreamAwareAnnotation, PageAnnotation, StructParentAwareAnnotation
{
    use HasStructParent;
