...
final class StampAnnotation extends DictionaryIndirectObject implements AppearanceStreamAwareAnnotation, PageAnnotation, StructParentAwareAnnotation
{
    use HasStructParent;
    ...
    public function __construct(
        ...
        private readonly string $icon = 'Draft',
