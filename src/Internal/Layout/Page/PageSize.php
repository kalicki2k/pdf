...
namespace Kalle\Pdf\Internal\Layout\Page;
...
final readonly class PageSize
{
    ...
    {
        return self::fromMillimeters(841.0, 1189.0);
    }
    ...
    {
        return self::fromMillimeters(1189.0, 1682.0);
    }
    ...
    {
        return self::fromMillimeters(594.0, 841.0);
    }
    ...
    {
        return self::fromMillimeters(420.0, 594.0);
    }
    ...
    {
        return self::fromMillimeters(297.0, 420.0);
    }
    ...
    {
        return self::fromMillimeters(210.0, 297.0);
    }
    ...
    {
        return self::fromMillimeters(148.0, 210.0);
    }
    ...
    {
        return self::fromMillimeters(105.0, 148.0);
    }
    ...
    {
        return self::fromMillimeters(74.0, 105.0);
    }
    ...
    {
        return self::fromMillimeters(52.0, 74.0);
    }
    ...
    {
        return self::fromMillimeters(37.0, 52.0);
    }
    ...
    {
        return self::fromMillimeters(1000.0, 1414.0);
    }
    ...
    {
        return self::fromMillimeters(707.0, 1000.0);
    }
    ...
    {
        return self::fromMillimeters(500.0, 707.0);
    }
    ...
    {
        return self::fromMillimeters(353.0, 500.0);
    }
    ...
    {
        return self::fromMillimeters(250.0, 353.0);
    }
    ...
    {
        return self::fromMillimeters(176.0, 250.0);
    }
    ...
    {
        return self::fromMillimeters(125.0, 176.0);
    }
    ...
    {
        return self::fromMillimeters(88.0, 125.0);
    }
    ...
    {
        return self::fromMillimeters(62.0, 88.0);
    }
    ...
    {
        return self::fromMillimeters(44.0, 62.0);
    }
    ...
    {
        return self::fromMillimeters(31.0, 44.0);
    }
    ...
    {
        return self::fromMillimeters(917.0, 1297.0);
    }
    ...
    {
        return self::fromMillimeters(648.0, 917.0);
    }
    ...
    {
        return self::fromMillimeters(458.0, 648.0);
    }
    ...
    {
        return self::fromMillimeters(324.0, 458.0);
    }
    ...
    {
        return self::fromMillimeters(229.0, 324.0);
    }
    ...
    {
        return self::fromMillimeters(162.0, 229.0);
    }
    ...
    {
        return self::fromMillimeters(114.0, 162.0);
    }
    ...
    {
        return self::fromMillimeters(81.0, 114.0);
    }
    ...
    {
        return self::fromMillimeters(57.0, 81.0);
    }
    ...
    {
        return self::fromMillimeters(40.0, 57.0);
    }
    ...
    {
        return self::fromMillimeters(28.0, 40.0);
    }
     ...
     * @throws InvalidArgumentException If width or height is not greater than zero.
     */
    public static function fromMillimeters(float $width, float $height): self
    {
        return new self($width * self::MM_TO_POINTS, $height * self::MM_TO_POINTS);
    }
