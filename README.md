...
- `PDF/A-4e`: im aktuellen engen Engineering-Scope freigegeben. Zusaetzlich zum PDF/A-4-Basisscope sind ein kleiner optional-content-Subset (`OCG`, `OCMD`, `VE`, `Configs`, `SetOCGState`), ein kleiner `RichMedia`-Subset und ein kleiner `3D`-Subset freigegeben. Breitere RichMedia-/3D-/Presentation-/Engineering-Wiring-Varianten bleiben blockiert.
