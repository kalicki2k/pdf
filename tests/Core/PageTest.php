...
final class PageTest extends TestCase
{
    ...
    public function it_adds_text_to_contents_and_registers_the_font_resource(): void
    {
        ...
        self::assertStringContainsString('/Font << /F1 6 0 R >>', $page->resources->render());
        ...
        self::assertStringContainsString('4 0 obj' . "\n" . '<< /Type /StructElem /S /Document /K [10 0 R] >>', $document->render());
        self::assertStringContainsString('10 0 obj' . "\n" . '<< /Type /StructElem /S /P /K [0 0 R] >>', $document->render());
    }
}
