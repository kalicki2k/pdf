...
enum DocumentBuildError: string
{
    ...
    case TEXT_LAYOUT_INVALID = 'text_layout_invalid';
    case IMAGE_LAYOUT_INVALID = 'image_layout_invalid';
    ...
    case PDFA4_ENGINEERING_FEATURE_NOT_ALLOWED = 'pdfa4_engineering_feature_not_allowed';
