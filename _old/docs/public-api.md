...
Bildplatzierung ist aktuell in drei Modi verfuegbar:

- relativ zur Seite ueber `ImagePlacement::absolute(left: ..., right: ..., top: ..., bottom: ..., width: ..., height: ...)`
- relativ zur ContentArea ueber `ImagePlacement::relative(left: ..., right: ..., top: ..., bottom: ..., width: ..., height: ...)`
- im Seitenfluss ueber `ImagePlacement::static(width: ..., height: ..., align: ImageAlign::LEFT|CENTER|RIGHT, spacingBefore: ..., spacingAfter: ...)`
