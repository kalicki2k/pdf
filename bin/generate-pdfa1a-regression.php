...
if ($argc !== 2) {
    fwrite(STDERR, "Usage: bin/generate-pdfa1a-regression.php <output-pdf>\n");
    exit(1);
}
...
$document = DefaultDocumentBuilder::make()
    ...
    ->title('PDF/A-1a Text Structure Regression')
    ->author('kalle/pdf2')
    ->subject('PDF/A-1a structured text regression fixture')
    ->language('de-DE')
